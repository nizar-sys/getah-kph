    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('getah-list.store') }}" method="POST" role="form" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal"
                                        placeholder="Tanggal Daftar Getah" value="{{ old('tanggal') }}" name="tanggal">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    placeholder="Uraian Daftar Getah" name="uraian" cols="30" rows="10">{{ old('uraian') }}</textarea>
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_penyadap') is-invalid @enderror" id="nama_penyadap"
                                        placeholder="Nama Penyadap Daftar Getah" value="{{ old('nama_penyadap') }}" name="nama_penyadap">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('petak') is-invalid @enderror" id="petak"
                                        placeholder="Petak Daftar Getah" value="{{ old('petak') }}" name="petak">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('luas') is-invalid @enderror" id="luas"
                                        placeholder="Luas Daftar Getah" value="{{ old('luas') }}" name="luas">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('jml_pohon') is-invalid @enderror" id="jml_pohon"
                                        placeholder="Jumlah Pohon Getah" value="{{ old('jml_pohon') }}" name="jml_pohon">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('target') is-invalid @enderror" id="target"
                                        placeholder="Target Pohon Getah" value="{{ old('target') }}" name="target">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('realisasi') is-invalid @enderror" id="realisasi"
                                        placeholder="Realisasi Pohon Getah" value="{{ old('realisasi') }}" name="realisasi">
